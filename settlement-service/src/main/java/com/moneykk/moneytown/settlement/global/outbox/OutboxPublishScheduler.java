...
public class OutboxPublishScheduler {
    ...
    private final SettlementOutboxMetrics settlementOutboxMetrics;
    ...
    public OutboxPublishScheduler(
            ...
            SettlementOutboxMetrics settlementOutboxMetrics
    ) {
        ...
        this.settlementOutboxMetrics = settlementOutboxMetrics;
    }
    ...
    public void publishPendingEvents() {
        ...
        try {
            ...
            settlementOutboxMetrics.recordOutboxPublishBatchFailure();
    ...
    public void recoverExpiredEvents() {
        try {
            ...
            settlementOutboxMetrics.recordOutboxRecoveryFailure();
    ...
    private String resolveMessageKey(
        ...
        // 배당 지급 요청: aggregateId(=payoutId)를 key로 써서 한 회차의 payout을 파티션 전체에 분산한다
        if (DividendPayoutDispatchPayload.EVENT_TYPE.equals(eventType)) {

...
class HoldingRevocationResultConsumerTest {

    private static final String TOPIC = "holding-revocation-result";
    private static final String CONSUMER_GROUP = "offering-service";
    private static final String CORRELATION_ID = "correlation-id";

    @Mock
    private HoldingRevocationResultService resultService;

    private ObjectMapper objectMapper;
    private HoldingRevocationResultConsumer consumer;

    @BeforeEach
    void setUp() {
        objectMapper = new ObjectMapper().findAndRegisterModules();

        consumer = new HoldingRevocationResultConsumer(
                objectMapper,
                resultService
        );
    ...
    @Test
    @DisplayName("Holding 회수 성공 이벤트는 성공 처리 서비스로 전달한다")
    ...
    @Test
    @DisplayName("Holding 회수 실패 이벤트는 실패 처리 서비스로 전달한다")
    ...
    private EventEnvelope<HoldingRevocationSucceededPayload>

...
public record SubscriptionDetailResponse(
        ...
        @Schema(
                description = "청약 접수 시점의 공모 단위 가격을 스냅샷으로 저장한 값",
                example = "100000"
        )
        Long pricePerUnit,
        ...
        @Schema(
                description = "PROCESSING 청약의 Wallet HOLD 처리 제한 시각",
                example = "2026-09-10T09:06:00Z"
        )
        Instant reservationExpiresAt,

        @Schema(
                description = "청약이 CONFIRMED 상태로 전환된 시각. 확정 전에는 값이 없습니다.",
                example = "2026-09-10T09:05:30Z"
        )
        Instant confirmedAt,

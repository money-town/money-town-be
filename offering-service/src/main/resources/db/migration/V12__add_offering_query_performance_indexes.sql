...
CREATE INDEX CONCURRENTLY IF NOT EXISTS
    idx_offerings_active_title_trgm
    ON p_offerings
...
-- 이슈어별 공모 목록의 기본 정렬
CREATE INDEX CONCURRENTLY IF NOT EXISTS
    idx_offerings_active_issuer_created
    ON p_offerings (
    issuer_id,
    created_at DESC,
    offering_id DESC
...
-- 공모 상태별 목록의 기본 정렬
CREATE INDEX CONCURRENTLY IF NOT EXISTS
    idx_offerings_active_status_created
    ON p_offerings (
    offering_status,
    created_at DESC,
    offering_id DESC
...
-- 투자자의 내 청약 목록 기본 정렬
CREATE INDEX CONCURRENTLY IF NOT EXISTS
    idx_subscriptions_active_user_created
    ON p_subscriptions (
    user_id,
    created_at DESC,

...
public class OutboxPublishScheduler {
    ...
    private final Counter publishBatchFailureCounter;
    ...
    public OutboxPublishScheduler(
        ...
        this.publishBatchFailureCounter = meterRegistry.counter(
                "asset.outbox.scheduler.failures", "scheduler", "publish_batch");
        this.recoveryFailureCounter = meterRegistry.counter(
                "asset.outbox.scheduler.failures", "scheduler", "recovery");
    }
    ...
    public void publishPendingEvents() {
        ...
        try {
            ...
            publishBatchFailureCounter.increment();
    ...
    private String resolveMessageKey(
        ...
        // 정산 연계 이벤트는 모두 assetId(aggregateId)를 key로 사용한다.
        if (!"AssetTerminationRequested".equals(eventType)
                && !"RevenueReady".equals(eventType)) {
            throw new IllegalArgumentException(
